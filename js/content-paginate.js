/**
 * A jquery plugin that paginates content based on the available height
 * @author Hezron Obuchele & Joseph Bosire
    ...
    $.fn.extend({ 
        ContentPagination: function(options) {
            ...
            updateCounter = function(i) {
                $('#page_number').html('Showing page ' + i + ' of ' + $(paginatePages).length);
            };
